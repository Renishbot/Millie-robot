...
import html
import requests
import Millie.modules.sql.chatbot_sql as sql
...
from Millie.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Millie import dispatcher, updater, SUPPORT_CHAT
from Millie.modules.log_channel import gloggable
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(f'http://Kukiapi.xyz/api/apikey={CHATBOT_KEY}/Vegeta/@renish_rgi/message='+Message)
